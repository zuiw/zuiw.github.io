...
"这是一个关于现代C++的博客专辑，会持续更新。\n"
    ...
    if(Array.isArray(albums['ModernC++'])) {
        albums['ModernC++'].push(post);
    } else {
        albums['ModernC++'] = [albums['ModernC++'], post];
    }
}
if(!albums['ModernC++']) {
    albums['ModernC++'] = [{
...
"持续更新中...\n"
    ...
    if(Array.isArray(albums['Python'])) {
        albums['Python'].push(post);
    } else {
        albums['Python'] = [albums['Python'], post];
    }
}
